...
public class CircleProgressBar extends ProgressBar {
    ...
    private static float DEFAULT_START_DEGREE = -90.0f;
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mLineWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_line_width,SizeUtils.dp2px(DEFAULT_LINE_WIDTH));
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_circle_progress_text_size, SizeUtils.dp2px(DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_circle_progress_stroke_width, SizeUtils.dp2px(DEFAULT_PROGRESS_STROKE_WIDTH));
    ...
    private void initPaint() {
        ...
        mProgressPaint.setMaskFilter(new BlurMaskFilter(3, BlurMaskFilter.Blur.SOLID));
    ...
    private void updateProgressShader() {
        if (mProgressStartColor != mProgressEndColor) {
            ...
            switch (mShader) {
                case LINEAR:
                    shader = new LinearGradient(mProgressRectF.left, mProgressRectF.bottom,
                            mProgressRectF.right, mProgressRectF.top,
                ...
                case SWEEP:
                    ...
                    shader = new SweepGradient(mCenterX, mCenterY-mRadius, new int[] {mProgressStartColor, mProgressEndColor},
                            new float[] {0.1f, 1f});
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        String progressText = String.format(mProgressTextFormatPattern,progressValue);
    ...
    private void drawLineProgress(Canvas canvas) {
        ...
        int progressLineCount = (int) (progressValue / (float) getMax() * mLineCount);
    ...
    private void drawSolidProgress(Canvas canvas) {
        ...
        canvas.drawArc(mProgressRectF, DEFAULT_START_DEGREE, 360.0f * progressValue / getMax(), true, mProgressPaint);
    }
    ...
    private void drawSolidLineProgress(Canvas canvas) {
        canvas.drawArc(mProgressRectF, DEFAULT_START_DEGREE, 360.0f, false, mProgressBackgroundPaint);
        canvas.drawArc(mProgressRectF, DEFAULT_START_DEGREE, 360.0f * progressValue / getMax(), false, mProgressPaint);
    }
    ...
    public void setProgressStartDegree(float degree) {
        this.DEFAULT_START_DEGREE = degree;
        updateProgressShader();
        invalidate();
    }
